...
export function GameReset() {
  ...
  const resetGameState = async () => {
    ...
    try {
      ...
      // Then explicitly set score to 25 for a new game
      ...
      console.log("Persuasion score reset to 25 for new game");
      
      toast({
        title: "Game Reset Complete",
        description: "Game state has been reset. New game will start with 5 minute timer and persuasion score of 25.",
        variant: "default",
      });
